...
function NorthAmerica4() {
    const [bird, setBird] = useState([]);
    const [birds, setBirds] = useState([]);

    useEffect(() => {
        fetch('https://nuthatch.lastelm.software/v2/birds?&page=4&pageSize=10&hasImg=true&operator=AND', {
            headers: {
    ...
    return (
        ...
        <thead>
            ...
            <button className ="header">
               <a href="/hotspots/NorthAmerica5">
               <h3>Next</h3>
               </a>
            </button>
            <button className ="header">
                <a href="/hotspots/NorthAmerica3">
                <h3>Back</h3>
                </a>
            </button>
           </body>
